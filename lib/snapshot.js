...
/**
 * List snapshot timestamps, newest first.
 *
 * Directory names are sanitized ISO timestamps of fixed width, so string
 * sort order equals chronological order.
 *
 * @returns {Promise<string[]>} snapshot timestamps, newest first
 */
