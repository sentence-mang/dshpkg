...
//
// Offline: weighted rank over the local four-source index —
 ...
 *
 * @param {string} query
 * @param {{online?: boolean, profile?: string, state?: object,
 *   index?: object[], fetcher?: Function}} opts
 * @returns {Promise<Array<object>>} [{...item, score, installed}] by
 *   descending score; name collisions keep the top score with `alternates`.
 */
export async function search(query, { online = false, profile = "web", state, index, fetcher } = {}) {
